...
from gr00t.model.transforms import GR00TTransform, GR00TTransformCL, GR00TTransformCL2
...
class SinglePandaGripperCLDataConfig(BimanualPandaGripperDataConfig):
    video_keys = [
        "video.left_view",
        "video.right_view",
        "video.wrist_view",
...
class SinglePandaGripperCL2DataConfig(BimanualPandaGripperDataConfig):
    video_keys = [
        "video.left_view",
        "video.right_view",
        "video.wrist_view",
    ...
    def modality_config(self):
        video_modality = ModalityConfig(
            # delta_indices=[0, [-4, 4][random.randint(0,1)]],
            # delta_indices=[0, 4],
            delta_indices=[0, -4],
            modality_keys=self.video_keys,
        )
...
DATA_CONFIG_MAP = {
    ...
    "bridge": BridgeDataConfig(),  # Placeholder for BridgeDataConfig
    "single_panda_gripper_cl": SinglePandaGripperCLDataConfig(),
    "single_panda_gripper_cl2": SinglePandaGripperCL2DataConfig(),
}

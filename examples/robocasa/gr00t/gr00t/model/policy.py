...
from gr00t.model.gr00t_n1_cl import GR00T_N1_5 as GR00T_N1_5_CL
...
class Gr00tPolicy(BasePolicy):
    ...
    def _load_model(self, model_path):
        if not self.contrastive:
            model = GR00T_N1_5.from_pretrained(model_path, torch_dtype=COMPUTE_DTYPE, backbone_model_type=self.backbone_model_type)
        else:
            # Load the CL version of the model
            model = GR00T_N1_5_CL.from_pretrained(
                        model_path, 
